...
import com.lucasvitor.projetocurso.domain.enums.EstadoPagamento;
import com.lucasvitor.projetocurso.domain.enums.Perfil;
...
import com.lucasvitor.projetocurso.repositories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Vítor Lucas", "vitorluc.2013@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,  pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Daniela Fernandes", "dani.g.f.b.deus@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
